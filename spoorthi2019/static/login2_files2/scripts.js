...
$('#btn-next-page').on('click', function(e) {
       ...
       parent_fieldset.find('input[type="text"], input[type="password"], textarea').each(function() {
        ...
        else
        {
          ...
          $("#personal").html('Hey ' + $("#form-first-name").val() + ', Thanks for becoming a part of Technex 19!<br>Checkout the <a href="/events"><u>Events</u></a> we have in store for you.  <br> And do not forget to verify your email. Also check your spam in case you don\'t find the confirmation mail in your primary inbox.<br>See ya soon :)');
           parent_fieldset.fadeOut(400, function() {
            $(this).next().fadeIn();
            });
